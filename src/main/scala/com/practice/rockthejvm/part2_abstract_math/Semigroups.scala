...
object Semigroups {
  ...
  // Exercise 2: implement reduceThings2 with the |+|
  ...
  def main(args: Array[String]): Unit = {
    ...
    // compiler will produce an implicit Semigroup[Option[Int]] - combine will produce another option with summed elements
